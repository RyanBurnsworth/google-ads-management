...
public class CampaignMocks {
    ...
    public static final String MOCK_KEYWORD_TEXT = "test keyword";
    ...
    public List<CampaignDetails> getMockCampaignDetailsList2() {
        List<CampaignDetails> mockCampaignDetailsList = new ArrayList<>();
        mockCampaignDetailsList.add(getMockCampaignDetailsWithoutCriterion());
        return mockCampaignDetailsList;
    }
    ...
    public CampaignDetails getMockCampaignDetails() {
        ...
        mockCampaignDetails.setCampaignCriteriaList(getMockCriterionDetailsList());

        return mockCampaignDetails;
    }
    public CampaignDetails getMockCampaignDetailsWithoutCriterion() {
        CampaignDetails mockCampaignDetails = new CampaignDetails();
        mockCampaignDetails.setCampaignName(MOCK_CAMPAIGN_NAME);
        mockCampaignDetails.setCampaignResourceName(MOCK_CAMPAIGN_RESOURCE_NAME);
        mockCampaignDetails.setStatus(CampaignStatusEnum.CampaignStatus.ENABLED_VALUE);
    ...
    public List<CriterionDetails> getMockCriterionDetailsList() {
        return getMockCriterionMapping().get(MOCK_CAMPAIGN_RESOURCE_NAME);
    }

    public List<CampaignCriterionOperation> getRemoveCampaignCriterionOpList() {
        List<String> campaignCriterionResourceNameList = new ArrayList<>();
        campaignCriterionResourceNameList.add(MOCK_CRITERION_RESOURCE_NAME);
        campaignCriterionResourceNameList.add("");
        campaignCriterionResourceNameList.add("");
        campaignCriterionResourceNameList.add("");
        campaignCriterionResourceNameList.add("");
        campaignCriterionResourceNameList.add("");
        ...
        campaignCriterionResourceNameList.forEach((resName) -> {
    ...
    public List<CampaignBudgetOperation> getMockCampaignBudgetCreateOperations() {
        ...
        CampaignBudgetOperation campaignBudgetOperation = CampaignBudgetOperation.newBuilder()
                .setCreate(getMockCampaignBudget())
                .build();

        campaignBudgetOperations.add(campaignBudgetOperation);
